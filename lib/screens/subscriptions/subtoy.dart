...
class FingerPrintIcon extends StatelessWidget {
  ...
  const FingerPrintIcon({required this.value});
...
// ignore: use_key_in_widget_constructors
class SubToy extends StatefulWidget {
  static const routeName = './subtoy.dart';

  @override
  State<SubToy> createState() => _SubToyState();
}

class _SubToyState extends State<SubToy> with SingleTickerProviderStateMixin {
  late AnimationController _controller;

  bool showFingerPrint = false;
  bool isAnimationCompleted = false, canDismiss = true;
  @override
  void initState() {
    super.initState();
      ...
      body: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: const Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 15),
                Text(
                  "Baby's Box of Joy is a program to help make the first few years of your child's development easy, fun and productive! We delivery science-based PlayTools based on your child's stage to spend more time conecting with your little one. Our PlayTools & services are based on neuroscience and created by childhood experts.",
                  style: TextStyle(
          ...
          SizedBox(
            ...
            child: Text(
              provider.getType() == 0
                  ? 'Recieve 3 toys per box.'
                  : 'Recieve 5 toys per box.',
              style: const TextStyle(
                color: Colors.white54,
                fontFamily: 'Open Sans',
                fontSize: 12,
