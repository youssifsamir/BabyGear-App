...
//screens
import 'marketsubs.dart';

// ignore: use_key_in_widget_constructors
class MarketLanding extends StatefulWidget {
  static const routeName = './marketLanding.dart';

  @override
  State<MarketLanding> createState() => _MarketLandingState();
}

class _MarketLandingState extends State<MarketLanding> {
  void skip(BuildContext context) {
    Navigator.of(context).popAndPushNamed(MarketSubs.routeName);
  }
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          //upperMessage
          const Text(
            "Got a product you're no longer using?\nOffer it for rent and earn endless money now!",
            style: TextStyle(
          ...
          //image
          Image.asset('./assets/images/market.gif'),

          const SizedBox(height: 40),
          //button
          GestureDetector(
            onTap: () {
              user.getByUsername(user.currentUser).disable
                  ? skip(context)
                  : showDialog(
                      context: context,
                                    ...
                                    children: <Widget>[
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              user.setDisable(check!);
                                              Navigator.pop(context);
                                              Navigator.of(context)
                                                  .popAndPushNamed(
                                                MarketSubs.routeName,
                                              );
                                            },
                                            child: Container(
                                              padding: const EdgeInsets.all(5),
